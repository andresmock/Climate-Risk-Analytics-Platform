...
[ADR-0010](0010-terraform-ci-developer-connect-admin-role.md), and
[ADR-0013](0013-terraform-ci-custom-role.md); apply-trigger mechanism superseded by
[ADR-0012](0012-terraform-apply-moves-local-only.md)
